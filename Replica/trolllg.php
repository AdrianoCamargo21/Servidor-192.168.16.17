...
$time = date('H:i:s');
$dia = date('d-m-Y');
if(!@($servori = pg_connect ("host = 192.168.11.2 dbname = troll port = 5430 user = postgres password = ky$14gr@"))){
    ...
    <html>
    <head>
    <meta http-equiv = 'refresh' content = '10' url = http://127.0.0.1/replica/trolllg.php';'>
...
if(!@($servdest = pg_connect ("host = 192.168.16.190 dbname = troll_lages port = 5430 user = postgres password = ky$14gr@"))){
...
$codini = 2048064; //Códifo Inicial da Replicação
...
if ($rsql == null) {
    ...
    <html>
    <head>
    <meta http-equiv = 'refresh' content = '5' url = http://127.0.0.1/replica/trolllg.php';'>
