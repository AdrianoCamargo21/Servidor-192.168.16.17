...
$time = date('H:i:s');
$dia = date('d-m-Y');
if(!@($servori = pg_connect ("host = 192.168.16.2 dbname = troll port = 5430 user = postgres password = ky$14gr@"))){
    ...
    <html>
    <head>
    <meta http-equiv = 'refresh' content = '10' url = http://127.0.0.1/replica/trollcdr.php';'>
...
if(!@($servdest = pg_connect ("host = 192.168.16.190 dbname = troll_cdr port = 5430 user = postgres password = ky$14gr@"))){
    ...
    echo "<p style = background:#D3D3D3; align = center <br/><b><font size=5 color=#FF0000>Servidor de Destino : Troll_Cdr Conectado</font></b></p>";
}
$codini = 756310; //Códifo Inicial da Replicação
...
if ($rsql == null) {
    ...
    <html>
    <head>
    <meta http-equiv = 'refresh' content = '5' url = http://127.0.0.1/replica/trollcdr.php';'>
